...
public class ViewapplicationsFragmentRecruiter extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        final TextView textView = root.findViewById(R.id.text_viewapplications_recruiter);
        viewapplicationsViewModelRecruiter.getText().observe(this, new Observer<String>() {
            @Override
